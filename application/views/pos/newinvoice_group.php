...
<script type="text/javascript">
    ...
    method: 'POST',
    data: {
        cid: $('#v2_categories').val(),
        wid: $('#v2_warehouses option:selected').val(),
        [crsf_token]: crsf_hash  // This ensures the CSRF token is added as a parameter correctly
    },
...
$(document).ready(function() {
    $(document).on('click', '.v2_select_pos_item_bar', function () {
        console.log('Product Clicked');
        var productName = $(this).data('name');
        console.log('Product Name:', productName);

        // Example: Add product to the cart (if applicable)
        var productHtml = `<div class="pos-item"><span><strong>${productName}</strong></span></div>`;
        
        // Assuming you have a container with id #pos_items
        $('#pos_items').append(productHtml);
        console.log('Product added to cart:', productHtml);
    });
});
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       $(document).on('change', 'v2_search_bar', function() {
